## COPY FEATURES FROM AN EXISTING FEARTURE TABLE ## 
...
## CALCULATE VARIABLES FROM FEATURE TIME SERIES ## 
...
## EXTRACT INFORMATION FOR A SPECIFIC CELL ## 
...
## MEAN RADIUS AND VARIANCE ON CENTROID TO BOUNDARY DISTANCES ##
...
## DOUBLE IMAFGE SIZE IN BOTH DIMENSIONS ##
...
## CALCULATE VARIABLES FROM WAVELET_TRANSFORMED TIME-SERIES ##
waveVars <- function(v)
{
 	wl = 0
