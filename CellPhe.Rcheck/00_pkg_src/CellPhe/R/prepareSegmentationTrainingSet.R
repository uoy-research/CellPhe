...
#'smotefamily::SMOTE() function to oversample the minority class to avoid biased classifier training. This function outputs feature tables
...
#' @return correctsegdata Original feature table of ground truth correctly segmented cells plus synthetic segmentation errors if this was the undersampled class
#' @return segerrorlabels List of true class labels for the segmentation error class
#' @return correctseglabels List of true class labels for the correctly segmented class
#'
#' @examples
