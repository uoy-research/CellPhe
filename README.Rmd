...
The output is a dataframe comprising the `FrameID` and `CellID` columns, the 72 features as columns, and any additional features that may be present (such as from `copyPhaseFeatures()`) in further columns.
